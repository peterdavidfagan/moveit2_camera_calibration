...
from robot_workspaces.yaskawa import Yaskawa
...
# TODO: right now lucid don't support camera info
...
class MainWindow(QMainWindow):
    ...
    def upload_application_parameters(self):
        ...
        if file_path:
            ...
            # TODO: read camera info from yaml
            # self.camera_info = CameraInfo()
            # self.camera_info.width = self.config["camera_info"]["width"]
            # self.camera_info.height = self.config["camera_info"]["height"]
            # self.camera_info.distortion_model = self.config["camera_info"]["distortion_model"]
            # self.camera_info.d = self.config["camera_info"]["d"]
            # self.camera_info.k = self.config["camera_info"]["k"]
            # self.camera_info.r = self.config["camera_info"]["r"]
            # self.camera_info.p = self.config["camera_info"]["p"]
            # self.camera_info.binning_x = self.config["camera_info"]["binning_x"]
            # self.camera_info.binning_y = self.config["camera_info"]["binning_y"]
